...
export const jsonplaceholder_post_posts_read = data => ({
  type: types.JSONPLACEHOLDER_POST_POSTS_READ,
  data
})
export const jsonplaceholder_post_posts_readSucceeded = (
  response,
  starter
) => ({
  type: types.JSONPLACEHOLDER_POST_POSTS_READ_SUCCEEDED,
  response,
  starter
})
export const jsonplaceholder_post_posts_readFailed = (error, starter) => ({
  type: types.JSONPLACEHOLDER_POST_POSTS_READ_FAILED,
  error,
  starter
})
export const jsonplaceholder_delete_posts_read = id => ({
  type: types.JSONPLACEHOLDER_DELETE_POSTS_READ,
  id
})
export const jsonplaceholder_delete_posts_readSucceeded = (
  response,
  starter
) => ({
  type: types.JSONPLACEHOLDER_DELETE_POSTS_READ_SUCCEEDED,
  response,
  starter
})
export const jsonplaceholder_delete_posts_readFailed = (error, starter) => ({
  type: types.JSONPLACEHOLDER_DELETE_POSTS_READ_FAILED,
  error,
  starter
})
