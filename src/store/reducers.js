...
const initialState = { jSONPlaceholder: [], tstdanielopenapiAPI: [] }

export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.JSONPLACEHOLDER_POST_POSTS_READ:
    case types.JSONPLACEHOLDER_POST_POSTS_READ_SUCCEEDED:
    case types.JSONPLACEHOLDER_POST_POSTS_READ_FAILED:
      return Object.assign({}, state, {
        jSONPlaceholder: [...state.jSONPlaceholder, action.response]
      })
    case types.JSONPLACEHOLDER_DELETE_POSTS_READ:
    case types.JSONPLACEHOLDER_DELETE_POSTS_READ_SUCCEEDED:
    case types.JSONPLACEHOLDER_DELETE_POSTS_READ_FAILED:
      return Object.assign({}, state, {
        jSONPlaceholder: [...state.jSONPlaceholder, action.response]
      })
    ...
    case types.API_V1_CUSTOMTEXT_LIST_FAILED:
      return Object.assign({}, state, {
        tstdanielopenapiAPI: [...state.tstdanielopenapiAPI, action.response]
      })
